    ...
    <PageTransition>
      ...
      <section ref={containerRef} className="relative min-h-screen flex items-center overflow-hidden">
        ...
        >
          ...
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')] bg-cover bg-center blur-[3px]" />
        </motion.div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-20 sm:py-28 lg:py-32">
          ...
          >
            ...
            >
              <span className="px-4 py-2 bg-white/20 text-white text-sm font-semibold backdrop-blur-md border border-white/30">
            ...
            >
              ...
              <motion.button
                ...
                className="btn-outline bg-white/20 hover:bg-white/30 text-white border-white/30 backdrop-blur-md"
              >
                Learn More
              </motion.button>
            </motion.div>
            ...
            {timeline.map((item, index) => (
              ...
              >
                <div className={`w-1/2 ${index % 2 === 0 ? 'pr-8' : 'pl-8'}`}>
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 p-8 relative">
                    <div className="absolute top-0 left-0 w-12 h-12 bg-primary-600 flex items-center justify-center transform -translate-x-1/2">
