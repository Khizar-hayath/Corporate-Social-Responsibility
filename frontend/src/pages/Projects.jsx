            ...
            <div className="mt-12 mb-6">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="flex items-center px-4 py-2 bg-primary-600 text-white hover:bg-primary-700"
                >
                  {showForm ? (
                    <>
          ...
          >
            {filteredProjects.map((project, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden group"
              >
