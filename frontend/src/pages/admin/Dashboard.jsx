      ...
      <div className="flex-1 p-8 ml-64">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            {statCards.map((stat, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray- Assert p-8"
              >
                <Link to={stat.link} className="flex items-center group">
                    <div className={`p-3 ${stat.color} group-hover:opacity-80 transition-opacity`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {donationStats.map((stat, index) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: index * 0.1 }}
                  className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-8"
                >
          ...
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-8 mb-10"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              {loading ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="w-full bg-gray-200 dark:bg-gray-700 h-2.5">
                    <div className="bg-blue-500 h-2.5" style={{ width: '65%' }}></div>
                  </div>
                  ...
                  <div className="w-full bg-gray-200 dark:bg-gray-700 h-2.5">
                    <div className="bg-green-500 h-2.5" style={{ width: '45%' }}></div>
                  </div>
                  ...
                  <div className="w-full bg-gray-200 dark:bg-gray-700 h-2.5">
                    <div className="bg-purple-500 h-2.5" style={{ width: '28%' }}></div>
                  </div>
                </div>
              )}
            </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                {quickActions.map((action, index) => (
                  <Link 
                    key={action.title}
                    to={action.link}
                    className="flex flex-col items-center justify-center p-4 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
                  >
              ...
              <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/30">
