...
const ProjectForm = ({ initialData, onSubmit, onCancel }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 p-8 border border-gray-200 dark:border-gray-700">
      {errors.form && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="col-span-full">
          ...
          <input
            ...
            className={`mt-3 block w-full px-5 py-4 border border-gray-300 ${
        ...
        <div>
          ...
          <div className="mt-3 relative">
            ...
            <input
              ...
              onChange={handleChange}
              className={`pl-7 block w-full px-5 py-4 border border-gray-300 ${
        ...
        <div className="col-span-full">
          ...
          <div className="mt-3 flex">
            <input
              ...
              onChange={handleChange}
              className="flex-1 block w-full px-5 py-4 border border-gray-300 focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
              placeholder="Image URL"
            />
            <button
              type="button"
              onClick={handleImageUpload}
              className="inline-flex items-center px-3 py-2 border border-l-0 border-gray-300 bg-gray-50 dark:bg-gray-600 text-gray-700 dark:text-gray-200 text-sm"
            >
