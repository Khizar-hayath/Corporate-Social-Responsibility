        ...
        {news.map((item) => (
          <tr key={item._id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
            ...
            <td className="px-6 py-4 whitespace-nowrap">
              <span className="px-2 py-1 inline-flex text-xs leading-5 font-semibold bg-primary-100 text-primary-800 dark:bg-primary-700 dark:text-primary-200">
                {item.category}
              </span>
            </td>
            ...
            <td className="px-6 py-4 whitespace-nowrap">
              <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold ${getStatusBadge(item.status)}`}>
