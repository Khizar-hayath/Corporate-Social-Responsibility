...
function CommentForm({ 
  ...
  return (
    <motion.form 
      ...
      className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 mb-6"
        ...
        {!isAuthenticated && !isEditing && (
          <div className="mb-3">
            <input
              ...
              className="w-full px-5 py-4 border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-900 text-gray-900 dark:text-white"
            />
          </div>
        )}
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          ...
          <button
            ...
            className={`btn-primary btn-sm ${!content.trim() ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
