      ...
      <AnimatePresence>
        {showAdvancedOptions && (
          <motion.div
            ...
            className="p-6 mb-6 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700"
          >
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full h-2 bg-gray-300 appearance-none cursor-pointer dark:bg-gray-700"
                />
        ...
        {error && (
          <motion.div
            ...
            animate={{ opacity: 1, height: 'auto' }}
            exit={{ opacity: 0, height: 0 }}
            className="p-4 mb-4 bg-red-50 dark:bg-red-900 text-red-600 dark:text-red-400"
          >
            {error}
          </motion.div>
        )}
        ...
        {showSummary && (
          <motion.div
            ...
            animate={{ opacity: 1, height: 'auto' }}
            exit={{ opacity: 0, height: 0 }}
            className="p-6 bg-primary-50 dark:bg-primary-900/20 mb-6 text-gray-800 dark:text-gray-200"
          >
