      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Project Description</h2>
            ...
            {project.goals && (
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Project Goals</h2>
